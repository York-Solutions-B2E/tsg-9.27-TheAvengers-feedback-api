...
* The original package name 'net.yorksolutions.tsg-9.27-TheAvengers-feedback-api' is invalid and this project uses 'net.yorksolutions.tsg_9.__TheAvengers_feedback_api' instead.
...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/3.4.11/reference/messaging/kafka.html)
